...
class ServidorWebTest : DescribeSpec({
  ...
  val servidorWeb=ServidorWeb()
    //val listaExtensiones= List <"TEXTO";"IMAGEN";"VIDEO">
    //val modulo=Modulo()
    ...
    it ("Si hay algun modulo que pueda responder al pedido se genera una respuesta "){

    }
    it("Si no hay algun modulo que puede responder al pedido se genera una respuesta "){
